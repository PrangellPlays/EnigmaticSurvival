...
import dev.prangellplays.enigmaticsurvival.client.screen.choicelectern.origin.IIWaterDragonChoiceLecternScreen;
...
public class IIWaterDragonChoiceLecternBlock extends BlockWithEntity {
    ...
    public IIWaterDragonChoiceLecternBlock(Settings settings) {
        super(settings);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        if (world.isClient) {
            MinecraftClient.getInstance().setScreen(new IIWaterDragonChoiceLecternScreen());
        }
