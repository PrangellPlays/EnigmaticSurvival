...
import dev.prangellplays.enigmaticsurvival.client.screen.choicelectern.origin.SemmpieChoiceLecternScreen;
...
public class SemmpieChoiceLecternBlock extends BlockWithEntity {
    ...
    public SemmpieChoiceLecternBlock(Settings settings) {
        super(settings);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        if (world.isClient) {
            MinecraftClient.getInstance().setScreen(new SemmpieChoiceLecternScreen());
        }
