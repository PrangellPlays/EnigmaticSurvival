...
import dev.prangellplays.enigmaticsurvival.client.screen.choicelectern.ChoiceLecternScreenDual;
...
public class ChoiceLecternBlankDualBlock extends BlockWithEntity {
    ...
    public ChoiceLecternBlankDualBlock(Settings settings) {
        super(settings);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        if (world.isClient) {
            MinecraftClient.getInstance().setScreen(new ChoiceLecternScreenDual());
        }
