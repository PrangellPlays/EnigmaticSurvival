...
import dev.prangellplays.enigmaticsurvival.client.screen.choicelectern.origin.PotatoBoyChoiceLecternScreen;
...
public class PotatoBoyChoiceLecternBlock extends BlockWithEntity {
    ...
    public PotatoBoyChoiceLecternBlock(Settings settings) {
        super(settings);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        if (world.isClient) {
            MinecraftClient.getInstance().setScreen(new PotatoBoyChoiceLecternScreen());
        }
