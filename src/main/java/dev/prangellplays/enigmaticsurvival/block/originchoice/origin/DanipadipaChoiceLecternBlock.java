...
import dev.prangellplays.enigmaticsurvival.client.screen.choicelectern.origin.BlimpTylerChoiceLecternScreen;
import dev.prangellplays.enigmaticsurvival.client.screen.choicelectern.origin.DanipadipaChoiceLecternScreen;
...
public class DanipadipaChoiceLecternBlock extends BlockWithEntity {
    ...
    public DanipadipaChoiceLecternBlock(Settings settings) {
        super(settings);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        if (world.isClient) {
            MinecraftClient.getInstance().setScreen(new DanipadipaChoiceLecternScreen());
        }
