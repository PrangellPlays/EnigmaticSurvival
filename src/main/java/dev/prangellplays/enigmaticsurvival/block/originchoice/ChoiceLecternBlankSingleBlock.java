package dev.prangellplays.enigmaticsurvival.block.originchoice;

import dev.prangellplays.enigmaticsurvival.block.originchoice.entity.ChoiceLecternBlockEntity;
import dev.prangellplays.enigmaticsurvival.client.screen.choicelectern.ChoiceLecternScreenSingle;
...
public class ChoiceLecternBlankSingleBlock extends BlockWithEntity {
    ...
    public ChoiceLecternBlankSingleBlock(Settings settings) {
        super(settings);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        if (world.isClient) {
            MinecraftClient.getInstance().setScreen(new ChoiceLecternScreenSingle());
        }
