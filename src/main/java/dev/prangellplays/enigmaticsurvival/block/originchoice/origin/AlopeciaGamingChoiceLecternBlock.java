...
public class AlopeciaGamingChoiceLecternBlock extends BlockWithEntity {
    ...
    public AlopeciaGamingChoiceLecternBlock(Settings settings) {
        super(settings);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        if (world.isClient) {
            MinecraftClient.getInstance().setScreen(new AlopeciaGamingChoiceLecternScreen());
        }
