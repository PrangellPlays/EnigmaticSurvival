...
import dev.prangellplays.enigmaticsurvival.client.screen.choicelectern.origin.PrangellPlaysChoiceLecternScreen;
...
public class PrangellPlaysChoiceLecternBlock extends BlockWithEntity {
    ...
    public PrangellPlaysChoiceLecternBlock(Settings settings) {
        super(settings);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        if (world.isClient) {
            MinecraftClient.getInstance().setScreen(new PrangellPlaysChoiceLecternScreen());
        }
